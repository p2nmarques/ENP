 ...
 */
         ...
         uint32_t application_sequence)
 {
     ...
     if (err == ESP_OK) {
         ESP_LOGI(TAG,
                  "ACK TX: origin=C destination=A next-hop=B seq=%lu data_seq=%lu app_seq=%lu ttl=%u",
 ...
 static void process_data(
  ...
  static void control_task(void *argument)
  {
      ...
      for (;;) {
          ESP_LOGI(TAG, "Type 'e3 start' for route discovery, 'e3 data' or 'e3 dup' on node A");
