...
/**
 * @brief Copy the transport address associated with a logical neighbor.
 *
 * The returned address is copied while the neighbor table is locked.
 * The caller does not receive a pointer into the table.
 */
esp_err_t
