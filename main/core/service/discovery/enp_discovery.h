...
#define ENP_DISCOVERY_CAP_ROUTING (UINT16_C(1) << 0)

#define ENP_DISCOVERY_CAP_ROOT (UINT16_C(1) << 1)

#define ENP_DISCOVERY_CAP_APPLICATION (UINT16_C(1) << 2)

#define ENP_DISCOVERY_CAP_SENSOR (UINT16_C(1) << 3)
...
#define ENP_DISCOVERY_PAYLOAD_SIZE ((uint16_t)sizeof(enp_discovery_payload_t))

_Static_assert(sizeof(enp_discovery_payload_t) == 4U,
