...
static bool valid_common(const uint8_t *buffer, size_t buffer_size,
						 size_t required_size, uint8_t expected_subtype) {
...
bool enp_routing_rreq_encode(const enp_routing_rreq_t *message, uint8_t *buffer,
							 size_t buffer_size) {
...
bool enp_routing_rreq_decode(enp_routing_rreq_t *message, const uint8_t *buffer,
							 size_t buffer_size) {
	if (message == NULL ||
		!valid_common(buffer, buffer_size, ENP_ROUTING_RREQ_WIRE_SIZE,
...
bool enp_routing_rrep_encode(const enp_routing_rrep_t *message, uint8_t *buffer,
							 size_t buffer_size) {
	if (message == NULL || buffer == NULL ||
...
bool enp_routing_rrep_decode(enp_routing_rrep_t *message, const uint8_t *buffer,
							 size_t buffer_size) {
	if (message == NULL ||
		!valid_common(buffer, buffer_size, ENP_ROUTING_RREP_WIRE_SIZE,
...
bool enp_routing_rerr_encode(const enp_routing_rerr_t *message, uint8_t *buffer,
							 size_t buffer_size) {
	if (message == NULL || buffer == NULL ||
...
bool enp_routing_rerr_decode(enp_routing_rerr_t *message, const uint8_t *buffer,
							 size_t buffer_size) {
	if (message == NULL ||
		!valid_common(buffer, buffer_size, ENP_ROUTING_RERR_WIRE_SIZE,
