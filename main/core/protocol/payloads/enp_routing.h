...
_Static_assert(sizeof(enp_routing_rreq_t) == ENP_ROUTING_RREQ_WIRE_SIZE,
			   "ENP RREQ wire size must be exactly 20 bytes");

_Static_assert(sizeof(enp_routing_rrep_t) == ENP_ROUTING_RREP_WIRE_SIZE,
			   "ENP RREP wire size must be exactly 20 bytes");

_Static_assert(sizeof(enp_routing_rerr_t) == ENP_ROUTING_RERR_WIRE_SIZE,
