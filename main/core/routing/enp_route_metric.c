...
bool enp_route_metric_init(enp_route_metric_t *metric,
...
bool enp_route_metric_add_hop(enp_route_metric_t *metric) {
...
int enp_route_metric_compare(const enp_route_metric_t *lhs,
